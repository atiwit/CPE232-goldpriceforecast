# =============================================================================
#  FEATURE ENGINEERING PIPELINE  (รวม Step 4.1 + 4.2)
#  Input  : ../data/processed/cleaned/cleanedoutput.csv
#  Output : ../data/processed/featured/featured_data_final.csv
#           ../data/processed/featured/feature_list.txt
# =============================================================================
...
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 1 : Load & Sanity Check")
print("=" * 60)
...
# =============================================================================
# 2 : FEATURE CREATION — TECHNICAL / PRICE  (จาก 4.1)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 2 : Technical / Price Features")
print("=" * 60)
...
# =============================================================================
# 3 : FEATURE CREATION — VOLATILITY & REGIME  (จาก 4.1)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 3 : Volatility & Regime Features")
print("=" * 60)
...
# =============================================================================
# 4 : FEATURE CREATION — CROSS-ASSET RATIOS  (จาก 4.1)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 4 : Cross-Asset Ratio Features")
print("=" * 60)
...
print("   Cross-asset features done")


# =============================================================================
# 5 : FEATURE CREATION — ROLLING CORRELATION  (จาก 4.1)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 5 : Rolling Correlation Features")
print("=" * 60)
...
print("   Rolling correlation features done")


# =============================================================================
# 6 : FEATURE CREATION — CALENDAR  (จาก 4.1)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 6 : Calendar Features")
print("=" * 60)
...
# =============================================================================
# 7 : FEATURE CREATION — LOG TRANSFORM  (จาก 4.1)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 7 : Log Transforms")
print("=" * 60)
...
print("   Log transforms done")


# =============================================================================
# 8 : FEATURE DROP & SELECTION  (จาก 4.1)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 8 : Feature Drop & Selection")
print("=" * 60)
...
# =============================================================================
# 9 : MACRO REGIME FEATURES — FRED  (จาก 4.2)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 9 : Macro Regime Features (FRED)")
print("=" * 60)
...
print("   Macro Regime features done")


# =============================================================================
# 10 : MARKET STRESS FEATURES  (จาก 4.2)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 10 : Market Stress Features")
print("=" * 60)
...
print("   Market Stress features done")


# =============================================================================
# 11 : GOLD MICROSTRUCTURE FEATURES  (จาก 4.2)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 11 : Gold Microstructure Features")
print("=" * 60)
...
print("   Gold Microstructure features done")


# =============================================================================
# 12 : LEAKAGE CHECK  (ครอบคลุมทั้ง 4.1 + 4.2 features)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 12 : Anti-Leakage Verification")
print("=" * 60)
...
# =============================================================================
# 13 : TARGET CREATION & FEATURE SHIFT  (จาก 4.1)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 13 : Target Creation & Feature Shift (anti-leakage)")
print("=" * 60)
...
# =============================================================================
# 14 : SKLEARN PIPELINE — SCALING & SPLIT  (จาก 4.1)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 14 : Train/Test Split & Preprocessing Pipeline")
print("=" * 60)
...
# =============================================================================
# 15 : SAVE — SINGLE FINAL CSV  (รวมจาก 4.1 + 4.2)
# =============================================================================
print("\n" + "=" * 60)
print("  STEP 15 : Save Final Output")
print("=" * 60)
